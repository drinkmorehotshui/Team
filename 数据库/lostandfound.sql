...
CREATE TABLE `academy` (
  ...
  KEY `SchoolCode` (`SchoolCode`) USING BTREE,
...
CREATE TABLE `classes` (
  ...
  PRIMARY KEY (`ID`) USING BTREE,
  KEY `ClassNo` (`ClassNo`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
INSERT INTO `expressthanks` VALUES ('16', '感谢javaniu', '感谢javaniu帮我找到了最代码牛币', '1', '2013031308', '2019-03-09 19:39:43');
...
CREATE TABLE `loginlog` (
  ...
  PRIMARY KEY (`ID`) USING BTREE,
  KEY `fk_loginlog` (`UID`) USING BTREE,
...
INSERT INTO `loginlog` VALUES ('157', '2013031308', 'Windows 7 ', 'Firefox 65.0', '127.0.0.1', '2019-03-09 19:35:56', '2');
INSERT INTO `loginlog` VALUES ('158', '2013031308', 'Windows 7 ', 'Firefox 65.0', '127.0.0.1', '2019-03-09 19:37:03', '2');
INSERT INTO `loginlog` VALUES ('159', '2013031308', 'Windows 7 ', 'Chrome 57.0.2987', '127.0.0.1', '2019-04-19 16:43:11', '2');
INSERT INTO `loginlog` VALUES ('160', '2013143205', 'Windows 7 ', 'Chrome 73.0.3683', '127.0.0.1', '2019-04-19 17:04:30', '793');
...
-- Records of notice
-- ----------------------------
INSERT INTO `notice` VALUES ('1', '平台上线通知公告', 'Hi!猿来入此校园失物招领平台V1.0测试版上线啦~。 欢迎大家使用哦~~所有数据均为测试数据哦', '1', '2017-04-15 16:38:50');
INSERT INTO `notice` VALUES ('3', '猿来入此', '猿来入此，Java经典项目教程学习网站！失物招领平台，当你丢了东西或者捡到东西后都可以在此平台上发布，大家可以浏览此信息，方便将失物归还及找到丢掉的东西！', '1', '2019-04-19 16:22:03');
...
INSERT INTO `pickthings` VALUES ('200', '饭卡', '教学楼', '2016-11-25', 'elec', '164', 'static\\upload\\find\\2017\\03\\2013143218\\20161130151920.jpg', '一张饭卡', null, null, '2016-12-07 11:34:12', '1', '2013143218', '1');
...
INSERT INTO `pickthings` VALUES ('270', '最代码牛币', 'zuidaima.com', '2019-03-09', 'book', null, 'static\\upload/find\\2019\\03\\2013031308/20190309193813852.jpg', '最代码网站牛币', 'zuidaima.com', '13520109202', '2019-03-09 19:38:13', '2', '2013031308', '2');
INSERT INTO `pickthings` VALUES ('271', '捡到一张饭卡', '食堂', '2019-04-18', 'card', '311', 'static\\upload/find\\2019\\04\\2013031308/20190419164743543.png', '白色卡片', '教学楼', '13520109202', '2019-04-19 16:47:43', '0', '2013031308', '2');
...
CREATE TABLE `student` (
  ...
  KEY `pk_classno` (`ClassNo`) USING BTREE,
...
CREATE TABLE `systemlog` (
  ...
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1069 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
INSERT INTO `systemlog` VALUES ('945', '访问主页', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-03-09 19:23:05');
INSERT INTO `systemlog` VALUES ('946', '访问主页', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-03-09 19:23:10');
INSERT INTO `systemlog` VALUES ('947', '访问主页', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-03-09 19:23:11');
INSERT INTO `systemlog` VALUES ('948', '访问主页', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-03-09 19:30:12');
INSERT INTO `systemlog` VALUES ('949', '网页登录', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.LoginController.login()', null, null, '2019-03-09 19:30:33');
INSERT INTO `systemlog` VALUES ('950', '网页登录', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.LoginController.login()', null, null, '2019-03-09 19:31:03');
INSERT INTO `systemlog` VALUES ('951', '网页登录', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.LoginController.login()', null, null, '2019-03-09 19:35:56');
INSERT INTO `systemlog` VALUES ('952', '获取发招领贴页面', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.PickThingsController.publishPickThingsView()', null, '2013031308', '2019-03-09 19:35:57');
INSERT INTO `systemlog` VALUES ('953', '注销', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.LoginController.logout()', null, '2013031308', '2019-03-09 19:36:21');
INSERT INTO `systemlog` VALUES ('954', '访问主页', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-03-09 19:36:22');
INSERT INTO `systemlog` VALUES ('955', '网页登录', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.LoginController.login()', null, null, '2019-03-09 19:37:03');
INSERT INTO `systemlog` VALUES ('956', '获取发招领贴页面', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.PickThingsController.publishPickThingsView()', null, '2013031308', '2019-03-09 19:37:04');
INSERT INTO `systemlog` VALUES ('957', '发招领贴', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.PickThingsController.publishPickThings()', null, '2013031308', '2019-03-09 19:38:13');
INSERT INTO `systemlog` VALUES ('958', '保存感谢信息', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.UserController.saveThanks()', null, '2013031308', '2019-03-09 19:39:43');
INSERT INTO `systemlog` VALUES ('959', '访问主页', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, '2013031308', '2019-03-09 19:40:01');
INSERT INTO `systemlog` VALUES ('960', '搜索', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.searchAll()', null, '2013031308', '2019-03-09 19:41:51');
INSERT INTO `systemlog` VALUES ('961', '搜索', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.searchAll()', null, '2013031308', '2019-03-09 19:41:58');
INSERT INTO `systemlog` VALUES ('962', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 10:59:24');
INSERT INTO `systemlog` VALUES ('963', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 10:59:33');
INSERT INTO `systemlog` VALUES ('964', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 10:59:54');
INSERT INTO `systemlog` VALUES ('965', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:00:04');
INSERT INTO `systemlog` VALUES ('966', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:00:09');
INSERT INTO `systemlog` VALUES ('967', '???????????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.PickThingsController.next()', null, null, '2019-04-19 11:00:40');
INSERT INTO `systemlog` VALUES ('968', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:01:59');
INSERT INTO `systemlog` VALUES ('969', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:02:03');
INSERT INTO `systemlog` VALUES ('970', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:02:32');
INSERT INTO `systemlog` VALUES ('971', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:04:36');
INSERT INTO `systemlog` VALUES ('972', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:04:50');
INSERT INTO `systemlog` VALUES ('973', '??', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.searchAll()', null, null, '2019-04-19 11:05:15');
INSERT INTO `systemlog` VALUES ('974', '??', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.searchAll()', null, null, '2019-04-19 11:05:32');
INSERT INTO `systemlog` VALUES ('975', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:05:35');
INSERT INTO `systemlog` VALUES ('976', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:06:14');
INSERT INTO `systemlog` VALUES ('977', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:07:15');
INSERT INTO `systemlog` VALUES ('978', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:08:12');
INSERT INTO `systemlog` VALUES ('979', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:08:39');
INSERT INTO `systemlog` VALUES ('980', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:09:01');
INSERT INTO `systemlog` VALUES ('981', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:10:22');
INSERT INTO `systemlog` VALUES ('982', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:10:37');
INSERT INTO `systemlog` VALUES ('983', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:15:45');
INSERT INTO `systemlog` VALUES ('984', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:15:45');
INSERT INTO `systemlog` VALUES ('985', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:15:46');
INSERT INTO `systemlog` VALUES ('986', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:15:46');
INSERT INTO `systemlog` VALUES ('987', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:15:46');
INSERT INTO `systemlog` VALUES ('988', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:15:49');
INSERT INTO `systemlog` VALUES ('989', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:15:49');
INSERT INTO `systemlog` VALUES ('990', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:15:49');
INSERT INTO `systemlog` VALUES ('991', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:15:50');
INSERT INTO `systemlog` VALUES ('992', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:15:50');
INSERT INTO `systemlog` VALUES ('993', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:15:56');
INSERT INTO `systemlog` VALUES ('994', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:15:59');
INSERT INTO `systemlog` VALUES ('995', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:15:59');
INSERT INTO `systemlog` VALUES ('996', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:16:52');
INSERT INTO `systemlog` VALUES ('997', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:16:53');
INSERT INTO `systemlog` VALUES ('998', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:16:53');
INSERT INTO `systemlog` VALUES ('999', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:16:53');
INSERT INTO `systemlog` VALUES ('1000', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:17:03');
INSERT INTO `systemlog` VALUES ('1001', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 11:17:09');
INSERT INTO `systemlog` VALUES ('1002', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 13:04:27');
INSERT INTO `systemlog` VALUES ('1003', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 13:11:41');
INSERT INTO `systemlog` VALUES ('1004', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 13:11:46');
INSERT INTO `systemlog` VALUES ('1005', '???????????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.PickThingsController.next()', null, null, '2019-04-19 13:12:10');
INSERT INTO `systemlog` VALUES ('1006', '???????????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.PickThingsController.next()', null, null, '2019-04-19 13:12:13');
INSERT INTO `systemlog` VALUES ('1007', '???????????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.PickThingsController.next()', null, null, '2019-04-19 13:12:15');
INSERT INTO `systemlog` VALUES ('1008', '???????????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.PickThingsController.next()', null, null, '2019-04-19 13:12:16');
INSERT INTO `systemlog` VALUES ('1009', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 13:12:20');
INSERT INTO `systemlog` VALUES ('1010', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 13:39:04');
INSERT INTO `systemlog` VALUES ('1011', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 13:42:05');
INSERT INTO `systemlog` VALUES ('1012', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 13:42:06');
INSERT INTO `systemlog` VALUES ('1013', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 13:42:27');
INSERT INTO `systemlog` VALUES ('1014', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 13:43:50');
INSERT INTO `systemlog` VALUES ('1015', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 13:44:01');
INSERT INTO `systemlog` VALUES ('1016', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 13:45:02');
INSERT INTO `systemlog` VALUES ('1017', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 13:51:21');
INSERT INTO `systemlog` VALUES ('1018', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 13:53:32');
INSERT INTO `systemlog` VALUES ('1019', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 13:54:09');
INSERT INTO `systemlog` VALUES ('1020', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 13:54:41');
INSERT INTO `systemlog` VALUES ('1021', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 13:54:52');
INSERT INTO `systemlog` VALUES ('1022', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 14:31:29');
INSERT INTO `systemlog` VALUES ('1023', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 14:31:34');
INSERT INTO `systemlog` VALUES ('1024', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 14:32:39');
INSERT INTO `systemlog` VALUES ('1025', '??', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.searchAll()', null, null, '2019-04-19 14:32:52');
INSERT INTO `systemlog` VALUES ('1026', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 14:33:06');
INSERT INTO `systemlog` VALUES ('1027', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 14:33:39');
INSERT INTO `systemlog` VALUES ('1028', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 14:34:03');
INSERT INTO `systemlog` VALUES ('1029', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 14:39:03');
INSERT INTO `systemlog` VALUES ('1030', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 14:40:14');
INSERT INTO `systemlog` VALUES ('1031', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 14:49:19');
INSERT INTO `systemlog` VALUES ('1032', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 14:51:38');
INSERT INTO `systemlog` VALUES ('1033', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 14:52:17');
INSERT INTO `systemlog` VALUES ('1034', '????', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 14:55:02');
INSERT INTO `systemlog` VALUES ('1035', '访问主页', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 16:42:42');
INSERT INTO `systemlog` VALUES ('1036', '网页登录', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.LoginController.login()', null, null, '2019-04-19 16:43:11');
INSERT INTO `systemlog` VALUES ('1037', '访问主页', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, '2013031308', '2019-04-19 16:43:12');
INSERT INTO `systemlog` VALUES ('1038', '进入用户中心', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.UserController.userCenter()', null, '2013031308', '2019-04-19 16:43:16');
INSERT INTO `systemlog` VALUES ('1039', '保存（修改）个人信息', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.UserController.saveUserInfo()', null, '2013031308', '2019-04-19 16:43:36');
INSERT INTO `systemlog` VALUES ('1040', '批量删除招领贴信息', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.UserController.removeFindInfoList()', null, '2013031308', '2019-04-19 16:44:31');
INSERT INTO `systemlog` VALUES ('1041', '获取发招领贴页面', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.PickThingsController.publishPickThingsView()', null, '2013031308', '2019-04-19 16:44:36');
INSERT INTO `systemlog` VALUES ('1042', '获取发招领贴页面', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.PickThingsController.publishPickThingsView()', null, '2013031308', '2019-04-19 16:45:02');
INSERT INTO `systemlog` VALUES ('1043', '获取发寻物贴页面', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.LostThingsController.publishLostThingsView()', null, '2013031308', '2019-04-19 16:45:03');
INSERT INTO `systemlog` VALUES ('1044', '获取发招领贴页面', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.PickThingsController.publishPickThingsView()', null, '2013031308', '2019-04-19 16:45:06');
INSERT INTO `systemlog` VALUES ('1045', '进入用户中心', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.UserController.userCenter()', null, '2013031308', '2019-04-19 16:45:26');
INSERT INTO `systemlog` VALUES ('1046', '访问主页', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, '2013031308', '2019-04-19 16:46:20');
INSERT INTO `systemlog` VALUES ('1047', '进入用户中心', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.UserController.userCenter()', null, '2013031308', '2019-04-19 16:46:22');
INSERT INTO `systemlog` VALUES ('1048', '获取发招领贴页面', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.PickThingsController.publishPickThingsView()', null, '2013031308', '2019-04-19 16:46:29');
INSERT INTO `systemlog` VALUES ('1049', '发招领贴', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.PickThingsController.publishPickThings()', null, '2013031308', '2019-04-19 16:47:43');
INSERT INTO `systemlog` VALUES ('1050', '访问主页', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, '2013031308', '2019-04-19 16:47:51');
INSERT INTO `systemlog` VALUES ('1051', '快速查看招领信息下一贴', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.PickThingsController.next()', null, '2013031308', '2019-04-19 16:48:07');
INSERT INTO `systemlog` VALUES ('1052', '进入用户中心', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.UserController.userCenter()', null, '2013031308', '2019-04-19 16:49:36');
INSERT INTO `systemlog` VALUES ('1053', '访问主页', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, '2013031308', '2019-04-19 16:50:31');
INSERT INTO `systemlog` VALUES ('1054', '获取发招领贴页面', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.PickThingsController.publishPickThingsView()', null, '2013031308', '2019-04-19 16:50:44');
INSERT INTO `systemlog` VALUES ('1055', '获取发寻物贴页面', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.LostThingsController.publishLostThingsView()', null, '2013031308', '2019-04-19 16:50:47');
INSERT INTO `systemlog` VALUES ('1056', '访问主页', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, '2013031308', '2019-04-19 16:51:01');
INSERT INTO `systemlog` VALUES ('1057', '访问主页', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, '2013031308', '2019-04-19 16:59:28');
INSERT INTO `systemlog` VALUES ('1058', '访问主页', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, '2013031308', '2019-04-19 16:59:48');
INSERT INTO `systemlog` VALUES ('1059', '访问主页', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, '2013031308', '2019-04-19 17:01:12');
INSERT INTO `systemlog` VALUES ('1060', '访问主页', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, '2013031308', '2019-04-19 17:02:14');
INSERT INTO `systemlog` VALUES ('1061', '进入聊天室', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.ChatMessageController.chat()', null, '2013031308', '2019-04-19 17:02:34');
INSERT INTO `systemlog` VALUES ('1062', '网页登录', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.LoginController.login()', null, null, '2019-04-19 17:04:23');
INSERT INTO `systemlog` VALUES ('1063', '网页登录', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.LoginController.login()', null, null, '2019-04-19 17:04:30');
INSERT INTO `systemlog` VALUES ('1064', '进入聊天室', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.ChatMessageController.chat()', null, '2013143205', '2019-04-19 17:04:35');
INSERT INTO `systemlog` VALUES ('1065', '进入聊天室', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.ChatMessageController.chat()', null, '2013143205', '2019-04-19 17:06:44');
INSERT INTO `systemlog` VALUES ('1066', '访问主页', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, '2013031308', '2019-04-19 17:07:47');
INSERT INTO `systemlog` VALUES ('1067', '注销', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.LoginController.logout()', null, '2013031308', '2019-04-19 17:08:05');
INSERT INTO `systemlog` VALUES ('1068', '访问主页', null, '0', '127.0.0.1', null, 'com.lin.lostandfound.controller.IndexController.index()', null, null, '2019-04-19 17:08:06');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', '2013143218', '21232f297a57a5a743894a0e4a801fc3', '2013', '黎国林', 'LinkMe', '15802850670', '1254403440@qq.com', '1254403440', '2', '2017-02-01', '0', '2017-04-25 18:09:57');
INSERT INTO `user` VALUES ('2', '2013031308', '21232f297a57a5a743894a0e4a801fc3', '2015', '猿来入此', '猿来入此', '13520109202', 'llq@qq.com', '1193284480', '1', '2017-02-07', '0', '2019-04-19 16:43:11');
INSERT INTO `user` VALUES ('3', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'ADMIN', '系统管理员', '系统管理员', '15802850670', '1254403440@qq.com', '', '3', '2017-02-01', '0', null);
...
INSERT INTO `user` VALUES ('793', '2013143205', '21232f297a57a5a743894a0e4a801fc3', '2013', '高增辉', '', '18388575815', '', '', '1', '2017-04-08', '0', '2019-04-19 17:04:30');
